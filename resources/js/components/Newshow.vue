			...
			<article class="u-shadow-v11 rounded g-pa-30">
				...
				<div class="media">
					<div class="media-body">
						<h3 class="h5 g-mb-10 sub-titulo">{{noticia.title}}</h3>
					</div>
				</div>
				<hr class="g-brd-gray-light-v4">
				<article>
					<img class="img-fluid w-70" :src="'/uploads/posts/'+noticia.image" alt="">
					<div class="espacio"></div>
					<div class="text-justify" v-html="noticia.content"></div>
				</article>
...
export default {
    ...
    methods: {
		readNota()
		{
			...
			axios.get('/api/noticias/' + ide)
			//axios.get('http://127.0.0.1:8888/Apps/Laravel/Lab/Vuejs/frontNormal/public/api/noticias/' + ide)
					.then(response => {
