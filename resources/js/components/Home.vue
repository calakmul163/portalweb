        ...
        <div class="container g-pt-50 g-pb-50">
            ...
            <div class="col-lg-12 g-mb-30 g-mb-0--lg">
	            <div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<a href="http://chiapas.gob.mx/media/plan-desarrollo-2019/Plan-Estatal-de-Desarrollo-Chiapas-2019-2024.pdf"><img class="img-fluid" src="http://chiapas.gob.mx/media/inicio/BannerPED.png" alt="Consulta Plan de Desarollo Chiapas 2019-2024"></a>
						</div>
					</div>
				</div>
            </div>
            ...
            <div class="col-lg-12 g-mb-30 g-mb-0--lg">
                ...
                <div class="row">
                    ...
                    <div v-for="galeria in galerias" class="col-lg-4 g-mb-30">
                        <!-- Article -->
                        <article class="u-block-hover">
                          <a :href="galeria.url" TARGET="_blank">
                          <figure class="u-bg-overlay ">
                              <img class="img-fluid u-block-hover__main--zoom-v1" :src="'/uploads/gallery/'+galeria.image" alt="Image Description">
                          </figure></a>
                        </article>
                        <!-- End Article -->
                    </div>
            ...
            <div class="col-lg-12 g-mb-30 g-mb-0--lg">
                ...
                <div class="row">
                    <div v-for="nota in notas" class="col-lg-4 g-mb-0--lg">
                        <article>
                            <img class="img-fluid w-100 g-mb-25" :src="'/uploads/posts/'+nota.image" alt="">
                            <div class="px-4">
            ...
            <div class="col-lg-12 g-mb-30 g-mb-0--lg">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 g-mb-30">
                        ...
                        <hr class="red">
                        <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2F1551117275206495&tabs=timeline&width=650&height=510&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=false&appId" width="650" height="510" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
                    </div>
                    <div v-if="enlaces" class="col-lg-6 g-mb-30">
                        <h3 class="h5 g-mb-10 sub-titulo">Información</h3>
                        <hr class="red">
                        <div id="bloqueinfoContent">
                            <ul>
                                <li v-for="enlace in enlaces" class="d-flex align-items-center">
                                    <div v-html="enlace.icono"></div>
                                    <span class="d-block">
...
export default {
    ...
    data () {
        return {
            ...
            enlaces: [
                {
                    icono: '<i class="icon-check d-block g-mr-8"></i>',
                    url: '#',
                    nombre: 'Armonización Contable - CONAC'
                },
                {
                    icono: '<i class="fa fa-file-pdf-o d-block g-mr-8"></i>',
                    url: 'http://www.seigen.chiapas.gob.mx/docs/decreto_creacion_sedem.pdf',
                    nombre: 'Decreto de Creación'
                },
                {
                    icono: '<i class="fa fa-file-pdf-o d-block g-mr-8"></i>',
                    url: 'http://seigen.chiapas.gob.mx/docs/leyes/Ley_de_Acceso_a_una_Vida_Libre_de_Violencia_para_las_Mujeres_en_el_Estado_de_Chiapas.pdf',
                    nombre: 'Ley de Acceso a una Vida Libre de Violencia para las Mujeres en el Estado de Chiapas'
                },
                {
                    icono: '<i class="fa fa-file-pdf-o d-block g-mr-8"></i>',
                    url: 'http://seigen.chiapas.gob.mx/docs/leyes/Ley_para_la_Igualdad_entre_Mujeres_y_Hombres_del_Estado_de_Chiapas.pdf',
                    nombre: 'Ley para la Igualdad entre Mujeres y hombres del Estado de Chiapas'
                },
                {
                    icono: '<i class="fa fa-file-pdf-o d-block g-mr-8"></i>',
                    url: 'http://seigen.chiapas.gob.mx/docs/manuales/Manual_de_Induccion_2018.pdf',
                    nombre: 'Manual de Inducción'
                },
                {
                    icono: '<i class="fa fa-file-pdf-o d-block g-mr-8"></i>',
                    url: 'http://seigen.chiapas.gob.mx/docs/manuales/MANUAL_DE_ORGANIZACION_2018.pdf',
                    nombre: 'Manual de Organización'
                },
                {
                    icono: '<i class="fa fa-file-pdf-o d-block g-mr-8"></i>',
                    url: 'http://seigen.chiapas.gob.mx/docs/manuales/manual_procedimiento_2018.pdf',
                    nombre: 'Manual de Procedimientos'
                },
                {
                    icono: '<i class="fa fa-file-pdf-o d-block g-mr-8"></i>',
                    url: 'http://seigen.chiapas.gob.mx/docs/ORGANIGRAMA.pdf',
                    nombre: 'Organigrama'
                },
                {
                    icono: '<i class="icon-globe d-block g-mr-8"></i>',
                    url: 'https://www.plataformadetransparencia.org.mx/inicio',
                    nombre: 'Plataforma Nacional de Transparencia - SIPOT'
                },
            ]
        }
    },
