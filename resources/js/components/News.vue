									...
									<nav class="navbar navbar-expand-lg navbar-light g-pa-0 g-right-0 g-pt-4 g-pb-4 g-bg-color-menu">
										...
										<div class="collapse navbar-collapse" id="navbarSupportedContent">
											<ul class="navbar-nav ml-auto g-font-size-15 g-font-weight-100">
												...
												<li class="nav-item g-mx-5--lg"><router-link class="nav-link g-color-white--hover g-bg-morado--hover g-rounded-3 g-text-underline g-font-weight-600" :to="{ name: 'news' }">Noticias</router-link></li>
...
<section class="container g-pt-150 g-pb-50">
		...
		<div class="masonry-grid row g-mb-20">
			<div  class="masonry-grid-sizer"></div>
				...
				<div v-for="noticia in noticias" class="masonry-grid-item col-sm-6 col-lg-4 g-mb-30">
					<article class="u-shadow-v11">
						<img class="img-fluid w-100" :src="'/uploads/posts/'+noticia.image" alt="">
						<div class="g-bg-white g-pa-30">
							<span class="d-block g-color-gray-dark-v4 g-font-weight-600 g-font-size-12 mb-2"></span>
							<router-link :to="{ name: 'newshow', params: { id: noticia.id } }" class="u-link-v5 g-color-gray-dark-v3 g-color-primary--hover">{{ noticia.title }}</router-link>
						</div>
					</article>
				</div>
...
const getNoticias = (informativas, callback) => {
    const params = { informativas };

	axios
		.get('/api/noticias')
        //.get('http://127.0.0.1:8888/Apps/Laravel/Lab/Vuejs/frontNormal/public/api/noticias', { params })
        .then(response => {
...
export default {
	...
	beforeRouteEnter (to, from, next) {
          getNoticias(to.query.informativas, (err, data) => {
